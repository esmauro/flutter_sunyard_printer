...
public class StringUtil {
     ...
     * 
     * @param format
     *            original format. yyyyMMdd HHmmss
     * @param toformat
    ...
    /**
     * @param str
     *            str Byte string(No separator between Byte,such as: [616C6B])
     ...
     * 
     * @param src
     *            src Byte string,there is no separator between each Byte
     * @return byte[]
     */
     ...
     * 
     * @param hex
     *            hex hexadecimal string（A Unicode is 2byte）
